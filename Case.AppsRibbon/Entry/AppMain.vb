...
#Region "Private Members - Buttons (PRO Apps)"

    ''' <summary>
    ''' Load the Controls
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub LoadItemsSubscription()
      ...
      Try
        ...
        If File.Exists(m_exceler8Path) Then
          ...
          Catch ex As Exception
            PostToLog(String.Format("LoadItemsSubscription Exceler8 Exception:" & vbCr & ex.ToString()))
          End Try
        ...
        Else
          PostToLog(String.Format("LoadItemsSubscription General Failure"))
        End If

      Catch ex As Exception
        PostToLog(String.Format("LoadItemsSubscription Exception:" & vbCr & ex.ToString()))
      End Try
...
#Region "Private Members - Buttons (FREE Apps)"

    ''' <summary>
    ''' Load the Free Items 
    ''' </summary>
    ''' <remarks></remarks>
    Private Function LoadItemsFree()
      ...
      Try
        ...
        Else
          PostToLog(String.Format("LoadItemsFree General Failure"))
        End If
      ...
      Catch ex As Exception
        PostToLog(String.Format("LoadItemsFree Exception:" & vbCr & ex.ToString()))
      End Try
