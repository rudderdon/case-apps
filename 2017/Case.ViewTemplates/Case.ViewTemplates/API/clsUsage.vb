...
#Region "Public Members"
    ...
    Public Sub RecordUsage(Optional useProxy As Boolean = False)
      ...
      ' Ignore My Calls
      If Environment.MachineName.ToLower = "case-platinum" And Environment.UserName.ToLower = "d.rudder" Then
        MsgBox("skipped for rudderdon")
        Exit Sub
      End If
      If Environment.MachineName.ToLower = "masterdonpc" And Environment.UserName.ToLower = "masterdon" Then
        MsgBox("skipped for rudderdon")
        Exit Sub
      End If
