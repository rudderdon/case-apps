  ...
  Private Sub SetFormViz(p_viz As formViz)
    Select Case p_viz
      Case formViz.isStandBy
        ...
        ButtonExport.Visibility = Windows.Visibility.Visible
        ButtonPreview.Visibility = Windows.Visibility.Visible
        ButtonParameterMapping.Visibility = Windows.Visibility.Visible
      Case formViz.isProcessing
        ProgressBar1.Visibility = Windows.Visibility.Visible
        ButtonCancel.Visibility = Windows.Visibility.Hidden
        ButtonExport.Visibility = Windows.Visibility.Hidden
        ButtonPreview.Visibility = Windows.Visibility.Hidden
        ButtonParameterMapping.Visibility = Windows.Visibility.Hidden
    End Select
  End Sub
