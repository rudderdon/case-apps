...
Public Class form_ImportMain
  ...
  Public Sub New(ByVal Settings As clsSettings)
    ...
    ' Form Set-Up
    ProgressBar_Import.Visibility = Windows.Visibility.Hidden
  ...
  Private Sub Button_Import_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button_Import.Click
    ...
    'Hide buttons
    Me.Button_Cancel.Visibility = Windows.Visibility.Hidden
    Me.Button_Import.Visibility = Windows.Visibility.Hidden

    'Show Progressbar
    Me.ProgressBar_Import.Visibility = Windows.Visibility.Visible
  ...
  ''' <param name="e"></param>
  ''' <remarks></remarks>
  Private Sub Button_Help_Click(sender As Object, e As Windows.RoutedEventArgs) Handles Button_Help.Click
