...
Public Class form_DataManager
  ...
  Public Sub New(p_s As clsSettings)
    ...
    Me.ComboBoxExcelWorksheet.Visibility = Windows.Visibility.Hidden
    Me.LabelExcelWorksheet.Visibility = Windows.Visibility.Hidden
  ...
  Private Sub SetFormVisibility(p_v As formViz)
    Select Case p_v
      Case formViz.isProcessing
        ...
        Me.ButtonUpdate.Visibility = Windows.Visibility.Hidden
        Me.ButtonCancel.Visibility = Windows.Visibility.Hidden
      Case formViz.isStandBy
        Me.ProgressBar1.Visibility = Windows.Visibility.Hidden
        Me.ButtonUpdate.Visibility = Windows.Visibility.Visible
        Me.ButtonCancel.Visibility = Windows.Visibility.Visible
    End Select
  End Sub
...
#Region "Form Controls & Events"
  ...
  Private Sub ButtonBrowse_Click(sender As System.Object, e As System.Windows.RoutedEventArgs) Handles ButtonBrowse.Click
    ...
    If Me.RadioButtonExcel.IsChecked = True Then
      ...
      Me.LabelFileLoad.Visibility = Windows.Visibility.Hidden
      Me.ComboBoxExcelWorksheet.Visibility = Windows.Visibility.Visible
      Me.LabelExcelWorksheet.Visibility = Windows.Visibility.Visible
    ...
    If Me.RadioButtonCSV.IsChecked = True Then
      ...
      Me.LabelFileLoad.Visibility = Windows.Visibility.Visible
      Me.ComboBoxExcelWorksheet.Visibility = Windows.Visibility.Hidden
      Me.LabelExcelWorksheet.Visibility = Windows.Visibility.Hidden
