...
Namespace Entry
  ...
  Public Class DE309158ACE741799F90E9210DEEF5F2

    Implements IExternalCommand

    Private _excel As clsExcel = Nothing
    ...
    Public Function Execute(ByVal commandData As ExternalCommandData,
      ...
      Try
        ...
        ' Version
        If Not commandData.Application.Application.VersionName.Contains("2015") Then

          Using td As New TaskDialog("Cannot Continue")
            With td
              .TitleAutoPrefix = False
              .MainInstruction = "Incompatible Revit Version"
              .MainContent = "This Add-In was built for Revit 2015, please contact CASE for assistance..."
              .Show()
            End With
          End Using
        ...
        End If
          ...
          Using d As New Windows.Forms.OpenFileDialog()
          ...
          ' Read Excel Data
          _excel = New clsExcel(m_path, m_s, EnumExcelSrartupMode.isExisting)
          _excel.GetHeaderData("key", True)

          ' Construct and Display the Form
          Using d As New form_Sync(m_s, _excel)
            d.ShowDialog()
          End Using
